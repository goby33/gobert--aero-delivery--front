        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: IconButton(
                ...
                onPressed: () {
                  context
                      .read<AddTripCubit>()
                      .addAirportFromSelected(state.trip!.airportFrom!);
          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                const TitleAddTrip(
                    title: 'What is the date of your departure ?'),
                Container(
                  child: TableCalendar(
                      locale: 'en_US',
                      rowHeight: 43,
                      ...
                      focusedDay:
                          (state is PopUpAddTripStateAddDateOfDepartureSelected)
                      ...
                      onDaySelected: (selectedDay, focusedDay) {
                        context
                            .read<AddTripCubit>()
                            .addDateOfDepartureSelected(focusedDay);
                      }),
                ),
                ButtonAddTrip(
                  onPressed: () {
                    context.read<AddTripCubit>().addDateOfDepartureReady();
